...
$hostname = "127.0.0.1:3307"; //127.0.0.1 si la BDD est sur la meme machine que le serveur web , sinon IP
...
if ($heure == '10' and $minute < '59'){ # si heure est comprise entre 00h00 et 00h30 on calcul la conso de la veille
