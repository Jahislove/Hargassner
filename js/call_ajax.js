...
// la liste des erreurs est contenue dans TabErreur (js/codes_erreurs.js)
		...
		document.getElementById('cell_0_1').innerHTML = chanel['puissance'];
		document.getElementById('cell_1_1').innerHTML = chanel['etat'];
		document.getElementById('cell_2_1').innerHTML = chanel['t2'];
		document.getElementById('cell_3_1').innerHTML = chanel['t3'];
		document.getElementById('cell_4_1').innerHTML = chanel['t4'];
		document.getElementById('cell_5_1').innerHTML = chanel['puissance'];
		document.getElementById('cell_6_1').innerHTML = chanel['puissance'];
		document.getElementById('cell_7_1').innerHTML = chanel['puissance'];
		document.getElementById('cell_8_1').innerHTML = chanel['puissance'];
		document.getElementById('cell_9_1').innerHTML = chanel['puissance'];
